...
namespace eTuristickaAgencija.Subscriber
{
    public class EmailService
    {
        ...
        public void SendEmail(string message)
        {
            try
            {
                ...
                string fromMail = Environment.GetEnvironmentVariable("SMTP_USERNAME") ?? "mo12star@hotmail.com";
                string password = Environment.GetEnvironmentVariable("SMTP_PASSWORD") ?? "Mostar12!3";
